...
typedef enum {
  ...
  // E1.37-8 PIDs
  PID_IFC_SESSION_CONTROL = 0x,
  PID_IFC_INTERFACE_ID_LIST = 0x,
  PID_IFC_INTERFACE_PARENT = 0x,
  PID_IFC_INTERFACE_ENABLE = 0x,
  PID_IFC_INTERFACE_HARDWARE_ADDRESS = 0x,
  PID_IFC_INTERFACE_FIXED_LABEL = 0x,
  PID_IFC_INTERFACE_USER_LABEL = 0x,
  PID_IFC_INTERFACE_TYPE = 0x,
  PID_IFC_INTERFACE_LINE_SPEED = 0x,
  PID_IFC_INTERFACE_UTILIZATION = 0x,
  PID_IFC_INTERFACE_DUPLEX_MODE = 0x,
  PID_IFC_INTERFACE_EEE = 0x,
  PID_IFC_INTERFACE_POWER_ENABLE = 0x,
  PID_IFC_INTERFACE_POWER_STATUS = 0x,
  PID_IFC_IPV4_ADDRESS = 0x,
  PID_IFC_IPV4_GATEWAY = 0x,
  PID_IFC_IPV4_GATEWAY_REMOVE = 0x,
  PID_IFC_IPV4_DNS = 0x,
  PID_IFC_IPV4_SUPPORTED_MODES = 0x,
  PID_IFC_IPV4_MODE = 0x,
  PID_IFC_IPV4_DHCP_RESULT = 0x,
  PID_IFC_IPV6_ADDRESS = 0x,
  PID_IFC_IPV6_ADDRESS_LINKLOCAL = 0x,
  PID_IFC_IPV6_GATEWAY = 0x,
  PID_IFC_IPV6_GATEWAY_REMOVE = 0x,
  PID_IFC_IPV6_DNS = 0x,
  PID_IFC_IPV6_SUPPORTED_MODES = 0x,
  PID_IFC_IPV6_MODE = 0x,
  PID_IFC_IPV6_DHCP_RESULT = 0x,
  PID_IFC_DNS_CAPABILITIES = 0x,
  PID_IFC_DNS_LABEL = 0x,
  PID_IFC_DNS_DOMAIN = 0x,
  PID_IFC_DNS_SEARCH_DOMAIN = 0x,
  PID_IFC_VLAN_CAPABILITIES = 0x,
  PID_IFC_VLAN_CONFIGURATION = 0x,
  PID_IFC_VLAN_LABEL = 0x,
} rdm_pid;
...
static const uint8_t RDM_IFC_SESSION_WINDOW_TIME = 60;
...
typedef enum {
  IFC_SESSION_OPERATION_DISCARD = 0x00,
  IFC_SESSION_OPERATION_COMMIT_RUNNING = 0x01,
  IFC_SESSION_OPERATION_COMMIT_RUNNING_PERSISTENT = 0x02,
  IFC_SESSION_OPERATION_CONFIRM = 0x03,
  IFC_SESSION_OPERATION_MAX,
} rdm_ifc_session_operation;

typedef enum {
  IFC_INTERFACE_STATE_DISABLE = 0x00,
  IFC_INTERFACE_STATE_ENABLE = 0x01,
  IFC_INTERFACE_STATE_BOUNCE = 0x02,
  IFC_INTERFACE_STATE_NOT_PRESENT = 0x03,
  IFC_INTERFACE_STATE_UNKNOWN = 0x04,
  IFC_INTERFACE_STATE_MAX,
} rdm_ifc_interface_state;
...
typedef enum {
  IFC_DUPLEX_MODE_HALF = 0x00,
  IFC_DUPLEX_MODE_FULL = 0x01,
  IFC_DUPLEX_MODE_MAX,
} rdm_ifc_duplex_mode;

typedef enum {
  IFC_EEE_STATE_DISABLE = 0x00,
  IFC_EEE_STATE_ENABLE = 0x01,
  IFC_EEE_STATE_MAX,
} rdm_ifc_eee_state;

typedef enum {
  IFC_POWER_STATE_DISABLE = 0x00,
  IFC_POWER_STATE_ENABLE = 0x01,
  IFC_POWER_STATE_MAX,
} rdm_ifc_power_state;

typedef enum {
  IFC_POWER_TYPE_NONE = 0x00,
  IFC_POWER_TYPE_POE_2P_TYPE_1 = 0x01,
  IFC_POWER_TYPE_POE_2P_TYPE_2 = 0x02,
  IFC_POWER_TYPE_POE_4P_TYPE_3 = 0x03,
  IFC_POWER_TYPE_POE_4P_TYPE_4 = 0x04,
  IFC_POWER_TYPE_SPOE_PODL = 0x05,
  IFC_POWER_TYPE_NON_STANDARD = 0x06,
  IFC_POWER_TYPE_MAX,
} rdm_ifc_power_type;

typedef enum {
  IFC_POWER_ROLE_NONE = 0x00,
  IFC_POWER_ROLE_POWER_SOURCING_EQUIPMENT = 0x01,
  IFC_POWER_ROLE_POWERED_DEVICE = 0x02,
  IFC_POWER_ROLE_OTHER = 0x03,
  IFC_POWER_ROLE_MAX,
} rdm_ifc_power_role;

typedef enum {
  IFC_IPV4_SOURCE_DHCP = 0x00,
  IFC_IPV4_SOURCE_STATIC = 0x01,
  IFC_IPV4_SOURCE_ZEROCONF = 0x02,
  IFC_IPV4_SOURCE_BOOTP = 0x03,
  IFC_IPV4_SOURCE_MAX,
} rdm_ifc_ipv4_source;

typedef enum {
  IFC_IPV4_SUPPORTED_MODE_DHCP = 0x00,
  IFC_IPV4_SUPPORTED_MODE_STATIC = 0x01,
  IFC_IPV4_SUPPORTED_MODE_ZEROCONF = 0x02,
  IFC_IPV4_SUPPORTED_MODE_BOOTP = 0x03,
  IFC_IPV4_SUPPORTED_MODE_MAX,
} rdm_ifc_ipv4_supported_mode;

typedef enum {
  IFC_IPV6_SOURCE_DHCP = 0x00,
  IFC_IPV6_SOURCE_STATIC = 0x01,
  IFC_IPV6_SOURCE_SLAAC = 0x02,
  IFC_IPV6_SOURCE_MAX,
} rdm_ifc_ipv6_source;

typedef enum {
  IFC_IPV6_SUPPORTED_MODE_DHCP = 0x00,
  IFC_IPV6_SUPPORTED_MODE_STATIC = 0x01,
  IFC_IPV6_SUPPORTED_MODE_SLAAC = 0x02,
  IFC_IPV6_SUPPORTED_MODE_MAX,
} rdm_ifc_ipv6_supported_mode;
