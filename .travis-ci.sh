...
if [[ $TASK = 'lint' ]]; then
  ...
  make builtfiles;
  travis_fold end "make_builtfiles"
  python${TRAVIS_PYTHON_VERSION} -m flake8 --max-line-length 80 --exclude *_pb2.py,.git,__pycache --ignore E111,E114,E121,E127,E129,W504 data/rdm include/ola python scripts tools/ola_mon tools/rdm
else
